...
object GGMLTensorUtils {
     ...
     */
    fun calculateContiguousStrides(ne: LongArray, type: io.github.kotlinmania.llama.core.GGMLType, maxDims: Int = io.github.kotlinmania.llama.core.GGML_MAX_DIMS): ULongArray {
