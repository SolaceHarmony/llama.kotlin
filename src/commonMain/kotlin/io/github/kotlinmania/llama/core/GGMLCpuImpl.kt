...
fun ggmlCpuFp32ToFp16(x: Float): UShort = io.github.kotlinmania.llama.core.ggmlFp32ToFp16(x)
fun ggmlCpuFp16ToFp32(x: UShort): Float = io.github.kotlinmania.llama.core.ggmlFp16ToFp32(x)
