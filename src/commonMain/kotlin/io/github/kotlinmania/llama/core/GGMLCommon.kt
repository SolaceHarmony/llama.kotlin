...
// Callers can `import io.github.kotlinmania.llama.core.*` and get everything.
...
internal const val IQ3S_N_SCALE: Int = io.github.kotlinmania.llama.core.QK_K / 64
...
internal const val QI1_0: Int = io.github.kotlinmania.llama.core.QK1_0 / 32

internal const val QR4_0: Int = 2
internal const val QI4_0: Int = io.github.kotlinmania.llama.core.QK4_0 / (4 * io.github.kotlinmania.llama.core.QR4_0)

internal const val QR4_1: Int = 2
internal const val QI4_1: Int = io.github.kotlinmania.llama.core.QK4_1 / (4 * io.github.kotlinmania.llama.core.QR4_1)

internal const val QR_MXFP4: Int = 2
internal const val QI_MXFP4: Int = io.github.kotlinmania.llama.core.QK_MXFP4 / (4 * io.github.kotlinmania.llama.core.QR_MXFP4)

internal const val QR_NVFP4: Int = 2
internal const val QI_NVFP4: Int = io.github.kotlinmania.llama.core.QK_NVFP4 / (4 * io.github.kotlinmania.llama.core.QR_NVFP4)

internal const val QR5_0: Int = 2
internal const val QI5_0: Int = io.github.kotlinmania.llama.core.QK5_0 / (4 * io.github.kotlinmania.llama.core.QR5_0)

internal const val QR5_1: Int = 2
internal const val QI5_1: Int = io.github.kotlinmania.llama.core.QK5_1 / (4 * io.github.kotlinmania.llama.core.QR5_1)

internal const val QR8_0: Int = 1
internal const val QI8_0: Int = io.github.kotlinmania.llama.core.QK8_0 / (4 * io.github.kotlinmania.llama.core.QR8_0)

internal const val QR8_1: Int = 1
internal const val QI8_1: Int = io.github.kotlinmania.llama.core.QK8_1 / (4 * io.github.kotlinmania.llama.core.QR8_1)

internal const val QR2_K: Int = 4
internal const val QI2_K: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR2_K)

internal const val QR3_K: Int = 4
internal const val QI3_K: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR3_K)

internal const val QR4_K: Int = 2
internal const val QI4_K: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR4_K)

internal const val QR5_K: Int = 2
internal const val QI5_K: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR5_K)

internal const val QR6_K: Int = 2
internal const val QI6_K: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR6_K)

internal const val QR2_XXS: Int = 4
internal const val QI2_XXS: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR2_XXS)

internal const val QR2_XS: Int = 4
internal const val QI2_XS: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR2_XS)

internal const val QR2_S: Int = 4
internal const val QI2_S: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR2_S)

internal const val QR3_XXS: Int = 4
internal const val QI3_XXS: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR3_XXS)

internal const val QR3_XS: Int = 4
internal const val QI3_XS: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR3_XS)

internal const val QR1_S: Int = 8
internal const val QI1_S: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR1_S)

internal const val QR1_M: Int = 8
internal const val QI1_M: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR1_M)

internal const val QR4_NL: Int = 2
internal const val QI4_NL: Int = io.github.kotlinmania.llama.core.QK4_NL / (4 * io.github.kotlinmania.llama.core.QR4_NL)

internal const val QR4_XS: Int = 2
internal const val QI4_XS: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR4_XS)

internal const val QR3_S: Int = 4
internal const val QI3_S: Int = io.github.kotlinmania.llama.core.QK_K / (4 * io.github.kotlinmania.llama.core.QR3_S)
...
data class BlockQ1_0(
    val d: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK1_0 / 8),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK1_0 / 8) { "qs.size must be ${io.github.kotlinmania.llama.core.QK1_0 / 8}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK1_0 / 8
    }
}
...
data class BlockQ4_0(
    val d: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK4_0 / 2),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK4_0 / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK4_0 / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK4_0 / 2
    }
}
...
data class BlockQ4_1(
    val d: Short,
    val m: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK4_1 / 2),
) {
    /** Packed pair of (d, m) as a single Int — matches C `ggml_half2 dm`. */
    val dm: Int get() = (d.toInt() and 0xFFFF) or ((m.toInt() and 0xFFFF) shl 16)

    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK4_1 / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK4_1 / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 * 2 + io.github.kotlinmania.llama.core.QK4_1 / 2
    }
}
...
data class BlockMXFP4(
    val e: Byte,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_MXFP4 / 2),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_MXFP4 / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_MXFP4 / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 1 + io.github.kotlinmania.llama.core.QK_MXFP4 / 2
    }
}
...
data class BlockNVFP4(
    val d: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_NVFP4 / io.github.kotlinmania.llama.core.QK_NVFP4_SUB),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_NVFP4 / 2),
) {
    init {
        require(d.size == io.github.kotlinmania.llama.core.QK_NVFP4 / io.github.kotlinmania.llama.core.QK_NVFP4_SUB) { "d.size must be ${io.github.kotlinmania.llama.core.QK_NVFP4 / io.github.kotlinmania.llama.core.QK_NVFP4_SUB}" }
        require(qs.size == io.github.kotlinmania.llama.core.QK_NVFP4 / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_NVFP4 / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = io.github.kotlinmania.llama.core.QK_NVFP4 / io.github.kotlinmania.llama.core.QK_NVFP4_SUB + io.github.kotlinmania.llama.core.QK_NVFP4 / 2
    }
}
...
data class BlockQ5_0(
    ...
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK5_0 / 2),
) {
    init {
        require(qh.size == 4) { "qh.size must be 4" }
        require(qs.size == io.github.kotlinmania.llama.core.QK5_0 / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK5_0 / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + 4 + io.github.kotlinmania.llama.core.QK5_0 / 2
    }
}
...
data class BlockQ5_1(
    ...
    val m: Short,
    val qh: ByteArray = ByteArray(4),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK5_1 / 2),
) {
    val dm: Int get() = (d.toInt() and 0xFFFF) or ((m.toInt() and 0xFFFF) shl 16)

    init {
        require(qh.size == 4) { "qh.size must be 4" }
        require(qs.size == io.github.kotlinmania.llama.core.QK5_1 / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK5_1 / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 * 2 + 4 + io.github.kotlinmania.llama.core.QK5_1 / 2
    }
}
...
data class BlockQ8_0(
    val d: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK8_0),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK8_0) { "qs.size must be ${io.github.kotlinmania.llama.core.QK8_0}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK8_0
    }
}
...
data class BlockQ8_1(
    val d: Short,
    val s: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK8_1),
) {
    val ds: Int get() = (d.toInt() and 0xFFFF) or ((s.toInt() and 0xFFFF) shl 16)

    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK8_1) { "qs.size must be ${io.github.kotlinmania.llama.core.QK8_1}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 * 2 + io.github.kotlinmania.llama.core.QK8_1
    }
}
...
data class BlockTQ1_0(
    val qs: ByteArray = ByteArray((io.github.kotlinmania.llama.core.QK_K - 4 * io.github.kotlinmania.llama.core.QK_K / 64) / 5),
    val qh: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 64),
    val d: Short,
) {
    init {
        require(qs.size == (io.github.kotlinmania.llama.core.QK_K - 4 * io.github.kotlinmania.llama.core.QK_K / 64) / 5) { "qs.size must be ${(io.github.kotlinmania.llama.core.QK_K - 4 * io.github.kotlinmania.llama.core.QK_K / 64) / 5}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 64) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 64}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK_K / 64 + (io.github.kotlinmania.llama.core.QK_K - 4 * io.github.kotlinmania.llama.core.QK_K / 64) / 5
    }
}
...
data class BlockTQ2_0(
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 4),
    val d: Short,
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 4) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 4}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK_K / 4
    }
}
 ...
 */
data class BlockQ2K(
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 16),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 4),
    val d: Short,
    val dmin: Short,
) {
    ...
    init {
        require(scales.size == io.github.kotlinmania.llama.core.QK_K / 16) { "scales.size must be ${io.github.kotlinmania.llama.core.QK_K / 16}" }
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 4) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 4}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 * 2 + io.github.kotlinmania.llama.core.QK_K / 16 + io.github.kotlinmania.llama.core.QK_K / 4
    }
}
 ...
 */
data class BlockQ3K(
    val hmask: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 8),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 4),
    val scales: ByteArray = ByteArray(12),
    val d: Short,
) {
    init {
        require(hmask.size == io.github.kotlinmania.llama.core.QK_K / 8) { "hmask.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 4) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 4}" }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK_K / 4 + io.github.kotlinmania.llama.core.QK_K / 8 + 12
    }
}
...
data class BlockQ4K(
    val d: Short,
    val dmin: Short,
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.K_SCALE_SIZE),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 2),
) {
    val dm: Int get() = (d.toInt() and 0xFFFF) or ((dmin.toInt() and 0xFFFF) shl 16)

    init {
        require(scales.size == io.github.kotlinmania.llama.core.K_SCALE_SIZE) { "scales.size must be ${io.github.kotlinmania.llama.core.K_SCALE_SIZE}" }
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 * 2 + io.github.kotlinmania.llama.core.K_SCALE_SIZE + io.github.kotlinmania.llama.core.QK_K / 2
    }
}
...
data class BlockQ5K(
    ...
    val dmin: Short,
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.K_SCALE_SIZE),
    val qh: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 8),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 2),
) {
    val dm: Int get() = (d.toInt() and 0xFFFF) or ((dmin.toInt() and 0xFFFF) shl 16)
    ...
    init {
        require(scales.size == io.github.kotlinmania.llama.core.K_SCALE_SIZE) { "scales.size must be ${io.github.kotlinmania.llama.core.K_SCALE_SIZE}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 8) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 * 2 + io.github.kotlinmania.llama.core.K_SCALE_SIZE + io.github.kotlinmania.llama.core.QK_K / 8 + io.github.kotlinmania.llama.core.QK_K / 2
    }
}
 ...
 */
data class BlockQ6K(
    val ql: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 2),
    val qh: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 4),
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 16),
    val d: Short,
) {
    init {
        require(ql.size == io.github.kotlinmania.llama.core.QK_K / 2) { "ql.size must be ${io.github.kotlinmania.llama.core.QK_K / 2}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 4) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 4}" }
        require(scales.size == io.github.kotlinmania.llama.core.QK_K / 16) { "scales.size must be ${io.github.kotlinmania.llama.core.QK_K / 16}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK_K / 16 + 3 * io.github.kotlinmania.llama.core.QK_K / 4
    }
}
...
data class BlockQ8K(
    val d: Float,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K),
    val bsums: ShortArray = ShortArray(io.github.kotlinmania.llama.core.QK_K / 16),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K}" }
        require(bsums.size == io.github.kotlinmania.llama.core.QK_K / 16) { "bsums.size must be ${io.github.kotlinmania.llama.core.QK_K / 16}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 4 + io.github.kotlinmania.llama.core.QK_K + (io.github.kotlinmania.llama.core.QK_K / 16) * 2
    }
}
...
data class BlockIQ2XXS(
    val d: Short,
    val qs: ShortArray = ShortArray(io.github.kotlinmania.llama.core.QK_K / 8),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 8) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + (io.github.kotlinmania.llama.core.QK_K / 8) * 2
    }
}
...
data class BlockIQ2XS(
    val d: Short,
    val qs: ShortArray = ShortArray(io.github.kotlinmania.llama.core.QK_K / 8),
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 32),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 8) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
        require(scales.size == io.github.kotlinmania.llama.core.QK_K / 32) { "scales.size must be ${io.github.kotlinmania.llama.core.QK_K / 32}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + (io.github.kotlinmania.llama.core.QK_K / 8) * 2 + io.github.kotlinmania.llama.core.QK_K / 32
    }
}
...
data class BlockIQ2S(
    val d: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 4),
    val qh: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 32),
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 32),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 4) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 4}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 32) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 32}" }
        require(scales.size == io.github.kotlinmania.llama.core.QK_K / 32) { "scales.size must be ${io.github.kotlinmania.llama.core.QK_K / 32}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK_K / 4 + io.github.kotlinmania.llama.core.QK_K / 16
    }
}
...
data class BlockIQ3XXS(
    val d: Short,
    val qs: ByteArray = ByteArray(3 * io.github.kotlinmania.llama.core.QK_K / 8),
) {
    init {
        require(qs.size == 3 * io.github.kotlinmania.llama.core.QK_K / 8) { "qs.size must be ${3 * io.github.kotlinmania.llama.core.QK_K / 8}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + 3 * (io.github.kotlinmania.llama.core.QK_K / 8)
    }
}
...
data class BlockIQ3S(
    ...
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 4),
    val qh: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 32),
    val signs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 8),
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.IQ3S_N_SCALE),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 4) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 4}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 32) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 32}" }
        require(signs.size == io.github.kotlinmania.llama.core.QK_K / 8) { "signs.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
        require(scales.size == io.github.kotlinmania.llama.core.IQ3S_N_SCALE) { "scales.size must be ${io.github.kotlinmania.llama.core.IQ3S_N_SCALE}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + 13 * (io.github.kotlinmania.llama.core.QK_K / 32) + io.github.kotlinmania.llama.core.IQ3S_N_SCALE
    }
}
...
data class BlockIQ1S(
    val d: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 8),
    val qh: ShortArray = ShortArray(io.github.kotlinmania.llama.core.QK_K / 32),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 8) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 32) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 32}" }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK_K / 8 + io.github.kotlinmania.llama.core.QK_K / 16
    }
}
...
data class BlockIQ1M(
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 8),
    val qh: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 16),
    val scales: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 32),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 8) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 8}" }
        require(qh.size == io.github.kotlinmania.llama.core.QK_K / 16) { "qh.size must be ${io.github.kotlinmania.llama.core.QK_K / 16}" }
        require(scales.size == io.github.kotlinmania.llama.core.QK_K / 32) { "scales.size must be ${io.github.kotlinmania.llama.core.QK_K / 32}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = io.github.kotlinmania.llama.core.QK_K / 8 + io.github.kotlinmania.llama.core.QK_K / 16 + io.github.kotlinmania.llama.core.QK_K / 32
    }
}
...
data class BlockIQ4NL(
    val d: Short,
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK4_NL / 2),
) {
    init {
        require(qs.size == io.github.kotlinmania.llama.core.QK4_NL / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK4_NL / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + io.github.kotlinmania.llama.core.QK4_NL / 2
    }
}
...
data class BlockIQ4XS(
    val d: Short,
    val scalesH: Short,
    val scalesL: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 64),
    val qs: ByteArray = ByteArray(io.github.kotlinmania.llama.core.QK_K / 2),
) {
    init {
        require(scalesL.size == io.github.kotlinmania.llama.core.QK_K / 64) { "scalesL.size must be ${io.github.kotlinmania.llama.core.QK_K / 64}" }
        require(qs.size == io.github.kotlinmania.llama.core.QK_K / 2) { "qs.size must be ${io.github.kotlinmania.llama.core.QK_K / 2}" }
    }
    ...
    companion object {
        ...
        const val SIZE_BYTES: Int = 2 + 2 + io.github.kotlinmania.llama.core.QK_K / 64 + io.github.kotlinmania.llama.core.QK_K / 2
    }
}
...
object GGMLCommonTables {
     ...
     */
    val iq1sGrid: LongArray by lazy { LongArray(io.github.kotlinmania.llama.core.NGRID_IQ1S) } // LATER: populate from ggml-common.h
}
...
internal fun verifyBlockSizes() {
    check(io.github.kotlinmania.llama.core.BlockQ1_0.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK1_0 / 8) { "wrong q1_0 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ4_0.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK4_0 / 2) { "wrong q4_0 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ4_1.SIZE_BYTES == 2 * 2 + io.github.kotlinmania.llama.core.QK4_1 / 2) { "wrong q4_1 block size" }
    check(io.github.kotlinmania.llama.core.BlockMXFP4.SIZE_BYTES == 1 + io.github.kotlinmania.llama.core.QK_MXFP4 / 2) { "wrong mxfp4 block size" }
    check(io.github.kotlinmania.llama.core.BlockNVFP4.SIZE_BYTES == io.github.kotlinmania.llama.core.QK_NVFP4 / io.github.kotlinmania.llama.core.QK_NVFP4_SUB + io.github.kotlinmania.llama.core.QK_NVFP4 / 2) { "wrong nvfp4 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ5_0.SIZE_BYTES == 2 + 4 + io.github.kotlinmania.llama.core.QK5_0 / 2) { "wrong q5_0 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ5_1.SIZE_BYTES == 2 * 2 + 4 + io.github.kotlinmania.llama.core.QK5_1 / 2) { "wrong q5_1 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ8_0.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK8_0) { "wrong q8_0 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ8_1.SIZE_BYTES == 2 * 2 + io.github.kotlinmania.llama.core.QK8_1) { "wrong q8_1 block size" }
    check(io.github.kotlinmania.llama.core.BlockTQ1_0.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK_K / 64 + (io.github.kotlinmania.llama.core.QK_K - 4 * io.github.kotlinmania.llama.core.QK_K / 64) / 5) { "wrong tq1_0 block size" }
    check(io.github.kotlinmania.llama.core.BlockTQ2_0.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK_K / 4) { "wrong tq2_0 block size" }
    check(io.github.kotlinmania.llama.core.BlockQ2K.SIZE_BYTES == 2 * 2 + io.github.kotlinmania.llama.core.QK_K / 16 + io.github.kotlinmania.llama.core.QK_K / 4) { "wrong q2_K block size" }
    check(io.github.kotlinmania.llama.core.BlockQ3K.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK_K / 4 + io.github.kotlinmania.llama.core.QK_K / 8 + 12) { "wrong q3_K block size" }
    check(io.github.kotlinmania.llama.core.BlockQ4K.SIZE_BYTES == 2 * 2 + io.github.kotlinmania.llama.core.K_SCALE_SIZE + io.github.kotlinmania.llama.core.QK_K / 2) { "wrong q4_K block size" }
    check(io.github.kotlinmania.llama.core.BlockQ5K.SIZE_BYTES == 2 * 2 + io.github.kotlinmania.llama.core.K_SCALE_SIZE + io.github.kotlinmania.llama.core.QK_K / 8 + io.github.kotlinmania.llama.core.QK_K / 2) { "wrong q5_K block size" }
    check(io.github.kotlinmania.llama.core.BlockQ6K.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK_K / 16 + 3 * io.github.kotlinmania.llama.core.QK_K / 4) { "wrong q6_K block size" }
    check(io.github.kotlinmania.llama.core.BlockQ8K.SIZE_BYTES == 4 + io.github.kotlinmania.llama.core.QK_K + (io.github.kotlinmania.llama.core.QK_K / 16) * 2) { "wrong q8_K block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ2XXS.SIZE_BYTES == 2 + (io.github.kotlinmania.llama.core.QK_K / 8) * 2) { "wrong iq2_xxs block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ2XS.SIZE_BYTES == 2 + (io.github.kotlinmania.llama.core.QK_K / 8) * 2 + io.github.kotlinmania.llama.core.QK_K / 32) { "wrong iq2_xs block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ2S.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK_K / 4 + io.github.kotlinmania.llama.core.QK_K / 16) { "wrong iq2_s block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ3XXS.SIZE_BYTES == 2 + 3 * (io.github.kotlinmania.llama.core.QK_K / 8)) { "wrong iq3_xxs block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ3S.SIZE_BYTES == 2 + 13 * (io.github.kotlinmania.llama.core.QK_K / 32) + io.github.kotlinmania.llama.core.IQ3S_N_SCALE) { "wrong iq3_s block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ1S.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK_K / 8 + io.github.kotlinmania.llama.core.QK_K / 16) { "wrong iq1_s block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ1M.SIZE_BYTES == io.github.kotlinmania.llama.core.QK_K / 8 + io.github.kotlinmania.llama.core.QK_K / 16 + io.github.kotlinmania.llama.core.QK_K / 32) { "wrong iq1_m block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ4NL.SIZE_BYTES == 2 + io.github.kotlinmania.llama.core.QK4_NL / 2) { "wrong iq4_nl block size" }
    check(io.github.kotlinmania.llama.core.BlockIQ4XS.SIZE_BYTES == 2 + 2 + io.github.kotlinmania.llama.core.QK_K / 64 + io.github.kotlinmania.llama.core.QK_K / 2) { "wrong iq4_xs block size" }
}
...
private val _blockSizeVerification: Unit = io.github.kotlinmania.llama.core.verifyBlockSizes()
